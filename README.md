...
- cd where2go
- npm run android
- npm run ios # you need to use macOS to build the iOS project - use the Expo app (https://docs.expo.dev/get-started/set-up-your-environment/) if you need to do iOS development without a Mac     
- npm run web
